...
public class UserPanelBreadcrumbItemTagHelper : TagHelper
{
    ...
    public UserPanelBreadcrumbItemTagHelper(IHtmlGenerator generator)
    {
        Generator = generator;
    }
    ...
    public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
    {
        ...
        if (LastActiveLink)
        {
            ...
            output.Content.SetHtmlContent($"<li class=\"flex\">\n<iconify-icon icon=\"uil:angle-left\" width=\"22\" height=\"22\"></iconify-icon>\n</li>\n<li class=\"*:text-light *:dark:text-[#A1A49D]\">\n<a href=\"javascript:void(0)\">{cc.GetContent()}</a>\n</li>");
            return;
        }
        ...
        output.SuppressOutput();
        output.Content.SetHtmlContent($"<li class=\"flex\">\n<iconify-icon icon=\"uil:angle-left\" width=\"22\" height=\"22\"></iconify-icon>\n</li>\n<li>\n<a href=\"{url}\">{childContent.GetContent()}</a>\n</li>");
    }
}
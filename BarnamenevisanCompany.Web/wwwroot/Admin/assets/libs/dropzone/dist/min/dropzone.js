    ...
    return function () {
        ...
        return function () {
            ...
            var s = {
                ...
                renameFile: null,
                forceFallback: !1,
                dictDefaultMessage: "برای آپلود، فایل‌ها را اینجا رها کنید",
                dictFallbackMessage: "مرورگر شما از آپلود فایل با کشیدن و رها کردن (drag'n'drop) پشتیبانی نمی‌کند..",
                dictFallbackText: "طفاً مانند گذشته از فرم جایگزین زیر برای آپلود فایل‌های خود استفاده کنید.",
                dictFileTooBig: "حجم فایل وارد شده بیشتر از حد مجاز است",
                dictInvalidFileType: "فرمت وارد شده پشتیبانی نمی شود",
                dictResponseError: "پاسخ سرور با {{statusCode}} برگشت",
                dictCancelUpload: "Cancel upload",
                dictUploadCanceled: "Upload canceled.",
                dictCancelUploadConfirmation: "آیا مطمئن هستید که می‌خواهید این آپلود را لغو کنید؟",
                dictRemoveFile: "Remove file",
                dictRemoveFileConfirmation: null,
                dictMaxFilesExceeded: "تعداد حد مجاز اپلود کردن فایل.",

...
export const persianTranslation= {
    fa: {
        "dictionary": {
            ...
            "Replace image": "جایگزینی عکس",
            "Upload from computer": "بارگزاری از دستگاه",
            "Replace from computer": "جاگزین کردن از دستگاه",
            "Upload image from computer": "بارگزاری عکس از دستگاه",
            "Image from computer": "عکس از دستگاه",
            "From computer": "از دستگاه",
            "Replace image from computer": "جایگزینی عکس از دستگاه",
            "Upload failed": "آپلود ناموفق بود",
            "You have no image upload permissions.": "",
            "Image toolbar": "نوارابزار تصویر",
            "Resize image": "تغیر اندازه عکس",
            "Resize image to %0": "تغییر اندازه عکس به 0 درصد",
            "Resize image to the original size": "تغییر اندازه عکس به سایز اصلی",
            "Resize image (in %0)": "تغییر اندازه عکس (در 0 درصد)",
            "Original": "اصلی",
            "Custom image size": "اندازه عکس سفارشس",
            "Custom": "سفارشس",
            "Image resize list": "",
            "Insert image via URL": "افزودن عکس از طریق url",
            "Insert via URL": "افزودن از طریق url",
            "Image via URL": "عکس از طریق url",
            "Via URL": "از طریق url",
            "Update image URL": "",

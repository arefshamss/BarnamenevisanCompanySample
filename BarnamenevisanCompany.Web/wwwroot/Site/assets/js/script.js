...
InitialToggleChangeThemeButtons();

function InitialTheme() {
    let theme = localStorage.getItem("color-theme") ?? "dark";
    if (theme === "dark") {
        document.documentElement.classList.remove('dark');
        InitialCkeditorTheme("light")
        InitialToggleChangeThemeButtons("light");
        localStorage.setItem("color-theme", "light");
  
    } else {
        document.documentElement.classList.add("dark")
        InitialCkeditorTheme("dark")
        InitialToggleChangeThemeButtons("dark");
        localStorage.setItem("color-theme", "dark");
    }
}
function InitialToggleChangeThemeButtons(theme = null){
    theme = theme ?? localStorage.getItem("color-theme") ?? "dark";
...
function InitialCkeditorTheme(theme = null) {
    theme = theme ?? localStorage.getItem("color-theme") ?? "dark";
    theme === "dark" ? setCkeditorThemeForSite("dark") : setCkeditorThemeForSite("light");
}

InitialCkeditorTheme();
themeToggleBtn.addEventListener("click", InitialTheme);

const btn = document.querySelector("button.mobile-menu-button"), menu = document.querySelector(".mobile-menu"),
...
if (document.getElementById("date").innerHTML = year, window.addEventListener("scroll", function () {
    ...
    const c = document.documentElement, d = getComputedStyle(c).getPropertyValue("--marquee-elements-displayed"),
...
let section_counter = document.querySelector("#counter"), counters = document.querySelectorAll(".counter");
if (section_counter) {
    let e = new IntersectionObserver((e, t) => {
        ...
        e.isIntersecting && (counters.forEach((n, e) => {
            n.innerHTML = "0";
            const a = () => {
                var e = +n.getAttribute("data-value"), t = +n.innerHTML;
...
let company_bar = document.querySelector("#company_bar"), companyBarItem = document.querySelectorAll(".companyBar");
if (company_bar) {
    let e = new IntersectionObserver((e, t) => {
        var [e] = e;
        e.isIntersecting && (companyBarItem.forEach((n, e) => {
            n.innerHTML = "0";
            const a = () => {
                var e = +n.getAttribute("data-value"), t = +n.innerHTML;
                t < e ? (n.innerHTML = `${Math.ceil(t + e / 5e3)}`, setTimeout(a, 1)) : n.innerHTML = e
            };
            a(), n.parentElement.style.animation ? n.parentElement.style.animation = "" : n.parentElement.style.animation = `slide-up 0.3s ease forwards ${e / companyBarItem.length + 1.5}s`
...
document.querySelectorAll(".faq-header").forEach(e => {
    e.addEventListener("click", () => {
        document.querySelectorAll(".faq-header").forEach(t => {
            if (t !== e && t.classList.contains("open")) {
                let e = t.nextElementSibling;
                e.classList = "faq-body collapsing", setTimeout(() => {
                    e.style.height = "0px"
                }, 1), setTimeout(() => {
                    e.classList = "faq-body close", e.style.height = ""
                }, 300), t.classList.remove("open")
            }
        });
        let t = e.nextElementSibling;
        if (!e.classList.contains("collapsing")) {
            if (e.classList.contains("open")) t.classList = "faq-body collapsing", setTimeout(() => {
                t.style.height = "0px"
            }, 1), setTimeout(() => {
...
const testimonial = new Swiper("#testionial", {
    ...
    autoplay: {delay: 2500, disableOnInteraction: !1},
    pagination: {el: ".swiper-pagination", clickable: !0}
}), integration = new Swiper("#integration", {
    loop: !0,
    centeredSlides: !0,
    autoplay: {delay: 2500, disableOnInteraction: !1},
    breakpoints: {640: {slidesPerView: 3}, 768: {slidesPerView: 5}, 1024: {slidesPerView: 9}}
}), timeline = new Swiper("#timeline", {loop: !0, direction: "vertical", spaceBetween: 45, slidesPerView: 3});
...
Fancybox.bind("[data-fancybox]", {}), gsap.registerPlugin(MotionPathPlugin), gsap.set("#rect, #rect-2, #rect-3, #rect-4, #rect-5, #rect-6", {opacity: 1}), gsap.from("#rect", {
    motionPath: {
        path: "#path",
        autoRotate: !0,
        align: "#path",
        alignOrigin: [.5, .5]
    }, duration: 2, ease: "none", repeat: -1, repeatDelay: 0
}), gsap.from("#rect-2", {
    motionPath: {path: "#path-2", autoRotate: !0, align: "#path-2", alignOrigin: [.5, .5]},
    duration: 2,
    ease: "none",
    repeat: -1,
    repeatDelay: 0
}), gsap.from("#rect-3", {
    motionPath: {path: "#path-3", autoRotate: !0, align: "#path-3", alignOrigin: [.5, .5]},
    duration: 2,
    ease: "none",
    repeat: -1,
    repeatDelay: 0
}), gsap.from("#rect-4", {
    motionPath: {path: "#path-4", autoRotate: !0, align: "#path-4", alignOrigin: [.5, .5]},
    duration: 2,
    ease: "none",
    repeat: -1,
    repeatDelay: 0
}), gsap.from("#rect-5", {
    motionPath: {path: "#path-5", autoRotate: !0, align: "#path-5", alignOrigin: [.5, .5]},
    duration: 2,
    ease: "none",
    repeat: -1,
    repeatDelay: 0
}), gsap.from("#rect-6", {
    motionPath: {path: "#path-6", autoRotate: !0, align: "#path-6", alignOrigin: [.5, .5]},
    duration: 2,
    ease: "none",
    repeat: -1,
    repeatDelay: 0
...
if (null != document.querySelector("#scene")) {
...
tabs.forEach(t => {
    t.addEventListener("click", () => {
        const e = document.querySelector(t.dataset.tabTarget);
        tabContents.forEach(e => {
            e.classList.remove("tab-items-active")
        }), tabs.forEach(e => {
            e.classList.remove("tab-active")
        }), t.classList.add("tab-active"), e.classList.add("tab-items-active")
    })
});
const countdownElement = document.getElementById("countdown");
if (countdownElement) {
    const la = new Date(countdownElement.getAttribute("data-date")).getTime();

    function formatNumber(e) {
        return e < 10 ? `0${e}` : e
    }

    const ma = setInterval(function () {
        var e = (new Date).getTime(), t = la - e, n = Math.floor(t / 864e5), a = Math.floor(t % 864e5 / 36e5),
            o = Math.floor(t % 36e5 / 6e4), e = Math.floor(t % 6e4 / 1e3), n = formatNumber(n), a = formatNumber(a),
            o = formatNumber(o), e = formatNumber(e);
        countdownElement.innerHTML = `${n} : ${a} : ${o} : ${e}`, t < 0 && (clearInterval(ma), countdownElement.innerHTML = "Countdown finished!")
    }, 1e3)
}